           ...
           <div class="tptrack__content grey-bg-3">
              <div class="tptrack__item d-flex mb-20">
                 ...
                 <div class="tptrack__item-content">
                    <h4 class="tptrack__item-title">Đăng nhập</h4>
                    <p>Đăng nhập bằng email và mật khẩu bạn dừa đăng ký.</p>
                 </div>
              </div>
...
>>>>>>> efc20b55ccc7691cf2246a06b335ff55e8be7799
                ...
                <form action="{{route('login-post')}}" method="post">
                    ...
                    <div class="tptrack__content grey-bg-3">
                        <div class="tptrack__item d-flex mb-20">
                            ...
                            <div class="tptrack__item-content">
                                <h3 class="tptrack__item-title text-danger">Đăng Nhập</h3>
                        ...
                        <p>Bạn chưa có tài khoản?<a href="{{route('register')}}" class="text-danger">Đăng kí ngay</a>
                        </p>
                        <div class="tptrack__btn mt-3">
                            <button class="tptrack__submition" type="submit">Đăng Nhập<i
