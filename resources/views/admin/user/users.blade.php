                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <p class="text-xs font-weight-bold mb-0">{{($alluser->currentPage() - 1) *
                                                $alluser->perPage() + $loop->index + 1 }}</p>
                                        ...
                                        <td class="align-middle">
                                            <a class="btn btn-link text-danger text-gradient px-3 mb-0"
                                                href="removeuser/{{$value->id}}"><i
                                                    class="far fa-trash-alt me-2"></i>Xóa</a>
                                            <a class="btn btn-link text-dark px-3 mb-0"
                                                href="edituser/{{$value->id}}"><i
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-2">
                            <form class="align-items-center mb-0" action="adduser" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="address" name="address"
                                        placeholder="Nhập địa chỉ" require>
                                </div>
                                <div class="mb-3">
