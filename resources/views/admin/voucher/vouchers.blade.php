                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{$value->value}}</span>
                                        </td>
                                        <td class="align-middle">
                                            <a class="btn btn-link text-danger text-gradient px-3 mb-0"
                                                href="removevoucher/{{$value->id}}"><i
                                                    class="far fa-trash-alt me-2"></i>Xóa
                                                sản phẩm</a>
                                            <a class="btn btn-link text-dark px-3 mb-0"
                                                href="editvoucher/{{$value->id}}"><i
