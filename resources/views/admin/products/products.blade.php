                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="d-flex px-2 py-1">
                        ...
                        <div>
                          <img src="{{asset('uploads/'.$value->img)}}" class="avatar avatar-sm me-3" alt="user1">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-2">
              <form class="align-items-center mb-0" action="{{route('admin/addproduct')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3  ">
                    ...
                    <input type="text" class="form-control " id="name" name="author" placeholder="Nhập tên tác giả" required>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="file" class="form-control" id="img" name="img" placeholder="Chọn ảnh" required>
                  </div>
                  <div class="col-md-6 mb-3">
                    <label for="gallery" class="form-label">Hình ảnh khác <span class="text-danger">(* 4 ảnh)</span> </label>
                    <input type="file" class="form-control" id="gallery" name="gallery[]" multiple placeholder="Chọn 4 ảnh khác" required>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6 mb-3">
                ...
                <div class="mb-3">
                  <label for="description" class="form-label">Mô tả chi tiết <span class="text-danger">(*
                      )</span> </label>
